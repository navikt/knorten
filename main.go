...
func main() {
	...
	router, err := api.New(dbClient, cfg.DryRun, cfg.ClientID, cfg.ClientSecret, cfg.TenantID, cfg.Hostname, cfg.SessionKey, cfg.AdminGroup, cfg.GCPProject, log.WithField("subsystem", "api"))
	if err != nil {
